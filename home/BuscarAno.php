...
<body>
	<?php 
		...
		$BuscarDados=$conexao->query("SELECT autor.nome,titulo,tipo_curso.tipo,ano,tipo_doc FROM documentos  INNER JOIN autor ON autor=id_autor INNER JOIN tipo_curso on tipo_curso=id_curso WHERE ano=$ano;");
	?>

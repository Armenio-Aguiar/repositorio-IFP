...
<body onload="slider()">
	<?php 
        ...
        FROM documentos  INNER JOIN autor ON autor=id_autor INNER JOIN tipo_curso on tipo_curso=id_curso WHERE tipo_curso = '$curso' and tipo_doc='$tipo' and disciplina = '$disciplina';");
	?>	
